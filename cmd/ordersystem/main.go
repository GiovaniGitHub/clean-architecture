...
import (
	...
	"github.com/GiovaniGitHub/clean-architecture/configs"
	"github.com/GiovaniGitHub/clean-architecture/internal/event/handler"
	"github.com/GiovaniGitHub/clean-architecture/internal/infra/graph"
	"github.com/GiovaniGitHub/clean-architecture/internal/infra/grpc/pb"
	"github.com/GiovaniGitHub/clean-architecture/internal/infra/grpc/service"
	"github.com/GiovaniGitHub/clean-architecture/internal/infra/web/webserver"
...
func main() {
	...
	rabbitMQChannel := getRabbitMQChannel(configs.AmpqChannelDial)
	...
	webserver.AddHandler("/order", "get", webOrderHandler.GetAll)
